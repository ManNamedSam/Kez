...
pub fn scanToken() Token {
    ...
    switch (c) {
        ...
        '+' => return makeToken(if (match('=')) TokenType.plus_equal else TokenType.plus),
        '-' => return makeToken(if (match('=')) TokenType.minus_equal else TokenType.minus),
        '/' => return makeToken(if (match('=')) TokenType.slash_equal else TokenType.slash),
        '*' => return makeToken(if (match('=')) TokenType.star_equal else TokenType.star),
        '%' => return makeToken(if (match('=')) TokenType.modulo_equal else TokenType.modulo),
